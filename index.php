...
<?php 
    ...
    $logo ="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/120px-Google_2015_logo.svg.png";
    $titoloPagina = "<h1>Privacy e termini</h1>";
    $imgUtente ="https://images.wired.it/wp-content/uploads/2017/03/06173639/1488814598_garfield.png";
    $menu =[
        [
            "Titolo" => "Introduzione",
            "Link" => "#",
...
<head>
    ...
    <title>Php Google Faq di Mattia De Bonis</title>
    <!-- css -->
...
<body>
    ...
    <header>
        ...
        <div class="header-top">
            ...
            <div>
                <?php
                    echo "<img src='".$imgUtente."' id='img-utente'>";
                ?>
            </div>
        </div>
        <!-- /header top -->
        ...
        <div>
            ...
            <ul class="menu">
                <?php 
                    foreach ($menu as $chiaveMenu => $valoreMenu) { 
                        echo "<li><a href='".$valoreMenu["Link"]."'>".$valoreMenu["Titolo"] . "</a></li>";
                    }
                ?>
            </ul>
            <!-- /menu -->
    ...
    <main>
        <ul>
            <?php
                ...
                foreach ($domandeFrequenti as $chiaveDomande => $valoreDomande) {
                    echo "<li class='faq'>".$valoreDomande["Domanda"]. "<br>".$valoreDomande["Risposta"]."</li>";
                }
            ?>
        </ul>
    </main>
