<?php 
    ...
    $domandeFrequenti =[
        ...
        [
            ...
            "Link" => [
                [
                    "Nome" => "decisione della Corte di giustizia dell'Unione europea",
                    "Link" => "#"
                ],
                [
                    "Nome" => "modulo web",
        ...
        [
            ...
            "Link" => [
                "Nome" => "Centro Google per la sicurezza online",
                "Link" => "#"
            ]
        ],
        //terza domanda
        ...
        [
            ...
            "Link" =>[
                ...
                [
                    "Nome" => "visitare la nostra pagina di assistenza per avere ulteriori informazioni-",
                    "Link" => "#"
                ],
    ...
    <ul>
        <?php
            foreach ($domandeFrequenti as $chiaveDomande => $valoreDomande) {
                echo("<li>" . $valoreDomande["Domanda"]. "<br>");
                echo($valoreDomande["Risposta"] . "</li>");
            }
        ?>
